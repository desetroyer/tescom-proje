...
const urunler = [
  {
    ...
    desc: 'Endüstriyel uygulamalar için yüksek güvenilirlikte, modüler ve ölçeklenebilir UPS çözümü. 50-600 kVA.',
  ...
  },
  {
    ...
    desc: 'Orta ölçekli endüstriyel uygulamalar için modüler UPS. 30-300 kVA.',
  ...
  },
  {
    ...
    desc: 'Küçük ve orta ölçekli endüstriyel uygulamalar için modüler UPS. 10-150 kVA.',
...
export default function CozumEndustriyel() {
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <Breadcrumb />
      <h1 className="text-3xl md:text-4xl font-bold text-blue-800 mb-2">Endüstriyel Çözümler</h1>
      <p className="text-lg text-gray-700 mb-8">Endüstriyel kontrol sistemleri ve otomasyon uygulamaları için güvenilir ve yüksek performanslı güç çözümleri sunuyoruz.</p>
